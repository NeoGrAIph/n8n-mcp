...
export const toolAnnotations: Record<string, ToolAnnotations> = {
  ...
  n8n_create_workflow: { readOnlyHint: false, destructiveHint: false, idempotentHint: false },
  n8n_get_workflow: { readOnlyHint: true, destructiveHint: false, idempotentHint: true },
  n8n_update_full_workflow: { readOnlyHint: false, destructiveHint: false, idempotentHint: false },
  n8n_update_partial_workflow: { readOnlyHint: false, destructiveHint: false, idempotentHint: false },
  n8n_delete_workflow: { readOnlyHint: false, destructiveHint: true, idempotentHint: false },
  n8n_list_workflows: { readOnlyHint: true, destructiveHint: false, idempotentHint: true },
  n8n_validate_workflow: { readOnlyHint: true, destructiveHint: false, idempotentHint: true },
