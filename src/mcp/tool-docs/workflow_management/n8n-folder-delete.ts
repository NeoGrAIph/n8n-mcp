...
export const n8nFolderDeleteDoc: ToolDocumentation = {
  ...
  essentials: {
    ...
    keyParameters: ['projectId', 'folderId'],
    example: 'n8n_folder_delete({projectId: "proj_123", folderId: "fold_empty"})',
  ...
  full: {
    ...
    examples: [
      'n8n_folder_delete({projectId: "proj_123", folderId: "fold_empty"}) - Delete empty folder'
    ],
    useCases: [
