...
exports.n8nFolderMoveDoc = void 0;
exports.n8nFolderMoveDoc = {
    name: 'n8n_folder_move',
    category: 'workflow_management',
    essentials: {
        description: 'Rename or move a folder within a project (internal REST API).',
        keyParameters: ['folderId', 'name', 'parentFolderId', 'projectId'],
        example: 'n8n_folder_move({folderId: "fold_1", parentFolderId: "fold_2"})',
    ...
    full: {
        ...
        examples: [
            'n8n_folder_move({folderId: "fold_1", name: "Ops"}) - Rename folder in your personal project',
...
//# sourceMappingURL=n8n-folder-move.js.map