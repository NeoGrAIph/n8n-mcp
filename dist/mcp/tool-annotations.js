...
exports.withToolAnnotations = withToolAnnotations;
exports.toolAnnotations = {
    ...
    n8n_workflow_runner_test: { readOnlyHint: false, destructiveHint: true, idempotentHint: false, openWorldHint: true },
    n8n_workflow_full_test: { readOnlyHint: false, destructiveHint: true, idempotentHint: false, openWorldHint: true },
...
function withToolAnnotations(tools) {
    return tools.map((tool) => {
        const annotations = exports.toolAnnotations[tool.name];
        if (!annotations) {
            return tool;
        }
