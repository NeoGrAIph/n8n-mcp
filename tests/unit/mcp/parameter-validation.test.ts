...
describe('Parameter Validation', () => {
  ...
  describe('Tools with No Required Parameters', () => {
    ...
    it('should allow n8n_tools_documentation with no parameters', async () => {
      const result = await server.testExecuteTool('n8n_tools_documentation', {});
    ...
    it('should allow n8n_tools_documentation with no parameters', async () => {
      const result = await server.testExecuteTool('n8n_tools_documentation', {});
      expect(result).toBeDefined();
      // n8n_tools_documentation returns an object with documentation content
