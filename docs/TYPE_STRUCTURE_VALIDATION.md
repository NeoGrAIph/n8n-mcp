...
Structure validation is automatically applied during node configuration validation. When you call `validate_node` (mode: `full` or `minimal`), the system:
