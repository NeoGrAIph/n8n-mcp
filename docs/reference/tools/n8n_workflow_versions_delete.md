# `n8n_workflow_versions_delete`

## Summary

Delete workflow versions for a workflow. Use this when you need to remove version history. Provide workflowId and optionally versionId or deleteAll to choose scope. Returns confirmation and permanently removes versions.
...
|---|---:|:---:|---:|---|
| `deleteAll` | boolean | no | False | Delete all versions for this workflow (delete mode only) |
| `versionId` | integer | no |  | Specific version ID to delete (optional) |
