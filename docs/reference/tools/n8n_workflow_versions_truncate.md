# `n8n_workflow_versions_truncate`

## Summary

Truncate all workflow versions globally. Use this only when you need a full reset of version history. Provide confirmTruncate=true to proceed. Returns the count of deleted versions.
...
|---|---:|:---:|---:|---|
| `confirmTruncate` | boolean | yes | False | REQUIRED: Must be true to truncate all versions |
