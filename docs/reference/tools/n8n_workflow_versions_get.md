# `n8n_workflow_versions_get`

## Summary

Get a specific workflow version by versionId. Use this when you need the exact snapshot for analysis or rollback planning. Provide versionId. Returns the full version record.
...
|---|---:|:---:|---:|---|
| `versionId` | integer | yes |  | Version ID (required) |
