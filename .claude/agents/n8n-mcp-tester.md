...
3. **Execute Tests Using MCP Tools**: You have access to all n8n-mcp tools including:
   - `n8n_nodes_search`: Find relevant n8n nodes
   ...
   - `n8n_workflow_validate`: Validate complete workflows
   - `get_node_example`: Get working examples
   - `n8n_templates_search`: Find workflow templates
...
1. Call `n8n_tools_documentation` to get a list of available tools and get documentation on `n8n_nodes_search` tool.
2. Search for HTTP Request node using `n8n_nodes_search`
...
6. Test in a complete workflow using `n8n_workflow_validate`
